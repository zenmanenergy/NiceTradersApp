...
TRANSLATIONS = {
    'en': {
        ...
        'from': 'from',
        'at': 'at',
        'listing_contact_access': 'has purchased contact access to your listing',
    ...
    'es': {
        ...
        'from': 'de',
        'at': 'a',
        'listing_contact_access': 'ha comprado acceso de contacto a tu anuncio',
    ...
    'fr': {
        ...
        'from': 'de',
        'at': 'à',
        'listing_contact_access': 'a acheté l\'accès aux contacts de votre annonce',
    ...
    'de': {
        ...
        'from': 'von',
        'at': 'um',
        'listing_contact_access': 'hat den Kontaktzugriff auf Ihre Anzeige gekauft',
    ...
    'pt': {
        ...
        'from': 'de',
        'at': 'em',
        'listing_contact_access': 'comprou acesso de contato para seu anúncio',
    ...
    'ja': {
        ...
        'from': 'から',
        'at': 'で',
        'listing_contact_access': 'があなたのリスティングへの連絡先アクセスを購入しました',
    ...
    'sk': {
        ...
        'from': 'od',
        'at': 'o',
        'listing_contact_access': 'kúpil prístup ku kontaktom vášho inzerátu',

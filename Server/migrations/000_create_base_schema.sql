...
-- This is the foundational migration that creates all core tables
-- All subsequent migrations build upon this schema
...
CREATE TABLE IF NOT EXISTS contact_access (
    ...
    rate_calculation_date DATE NULL,
    from_currency VARCHAR(10) NULL,
    to_currency VARCHAR(10) NULL,
    usd_rate_from DECIMAL(15,8) NULL,
    usd_rate_to DECIMAL(15,8) NULL,
...
-- Create meeting_proposals table for scheduling meetings
...
-- Create exchange_history table for user exchange records
